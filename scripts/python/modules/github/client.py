...
class GitHubClient:
    ...
    def create_repository(self, params: dict[str, Any]) -> tuple[dict[str, Any], dict[str, str]]:
        ...
        body = {
            ...
            "has_issues": bool(params.get("has_issues", True)),
            "has_projects": bool(params.get("has_projects", True)),
            "has_wiki": bool(params.get("has_wiki", True)),
            "auto_init": bool(params.get("auto_init", False)),
